...
public class ConveyorControlUp : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        RaycastHit2D hit = Physics2D.Raycast(new Vector3(transform.position.x+0.5f,transform.position.y,transform.position.z), Vector2.up,castdistance);
